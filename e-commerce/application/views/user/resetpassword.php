            ...
            <div class="card-content height100 m0" data-background-color="loginBlue">
                <div class="alignVMiddle" style="margin: 0 auto;width: 280px;padding-top: 30vh;">
                    ...
                    <div id="loginopen">
                        ...
                        <?php echo form_open(base_url('user/updatepassword'), array('id' => 'forgotPasswordForm')); ?>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group"> 
                                    <input id="password" type="password" class="form-control login-boxed-input text-white text-center" placeholder="Enter password" name="password">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group"> 
                                    <input id="npassword" type="password" class="form-control login-boxed-input text-white text-center" placeholder="Confirm password" name="npassword">
                                    <input id="femail" type="hidden" class="form-control login-boxed-input text-white text-center" placeholder="Confirm password" name="_token" value="<?php echo isset($token) ? $token : ''; ?>">
                                </div>
                            </div>
                        </div>
                        <div class="row">
